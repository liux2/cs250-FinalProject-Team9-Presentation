# cs250s2018-presentation
Presentation slides for Allegheny College cs250 final presentation

This repository is created for me to have a template for my presentation. you can view the slide at [here](http://cdn.rawgit.com/liux2/cs250-FinalProject-Team9-Presentation/master/presentation.html).

## Installation Instructions

You can type the following command if you want to clone similar repository:
